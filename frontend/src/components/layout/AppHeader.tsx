...
const AppHeader = () => {
  ...
  return (
    <header className="h-16 sticky top-0 z-50 border-b border-border bg-gradient-to-r from-slate-50 to-blue-50 dark:from-slate-900 dark:to-blue-900 backdrop-blur-md">
